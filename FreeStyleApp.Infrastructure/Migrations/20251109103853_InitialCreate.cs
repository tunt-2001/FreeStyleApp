    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFeatureGroups", x => new { x.UserId, x.FeatureGroupId });
                    table.ForeignKey(
                        name: "FK_UserFeatureGroups_FeatureGroups_FeatureGroupId",
                        column: x => x.FeatureGroupId,
                        principalTable: "FeatureGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFeatureGroups_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFeatureGroups_FeatureGroupId",
